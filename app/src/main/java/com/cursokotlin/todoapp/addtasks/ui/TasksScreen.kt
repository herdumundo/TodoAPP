...
fun TaskScreen(tasksViewModel: TasksViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        AddTasksDialog(showDialog, onDismiss = { tasksViewModel.onDialogClose() }, onTaskAdd = {tasksViewModel.onTasksCreated(it)})
        FabDialog(
            Modifier
...
fun FabDialog(modifier: Modifier,tasksViewModel: TasksViewModel) {
    FloatingActionButton(onClick = {tasksViewModel.onShowDialogSelected()}, modifier = modifier) {
